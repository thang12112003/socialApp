...
export class NzSubmenuService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.1", ngImport: i0, type: NzSubmenuService, deps: [{ token: i1.MenuService }], target: i0.ɵɵFactoryTarget.Injectable }); }
