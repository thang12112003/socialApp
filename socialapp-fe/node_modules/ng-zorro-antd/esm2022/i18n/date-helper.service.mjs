...
export class DateHelperService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.1", ngImport: i0, type: DateHelperService, deps: [{ token: i1.NzI18nService }], target: i0.ɵɵFactoryTarget.Injectable }); }
