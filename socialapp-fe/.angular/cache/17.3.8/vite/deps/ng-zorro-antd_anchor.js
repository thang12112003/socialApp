...
_NzAnchorComponent.ɵfac = function NzAnchorComponent_Factory(t) {
  return new (t || _NzAnchorComponent)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(NzScrollService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2));
};
_NzAnchorComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    nzAffix: [InputFlags.HasDecoratorInputTransform, "nzAffix", "nzAffix", booleanAttribute],
    nzShowInkInFixed: [InputFlags.HasDecoratorInputTransform, "nzShowInkInFixed", "nzShowInkInFixed", booleanAttribute],
    nzBounds: [InputFlags.HasDecoratorInputTransform, "nzBounds", "nzBounds", numberAttribute],
    nzOffsetTop: [InputFlags.HasDecoratorInputTransform, "nzOffsetTop", "nzOffsetTop", numberAttributeWithZeroFallback],
    nzTargetOffset: [InputFlags.HasDecoratorInputTransform, "nzTargetOffset", "nzTargetOffset", numberAttributeWithZeroFallback],
