...
_NzDividerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzDashed: [InputFlags.HasDecoratorInputTransform, "nzDashed", "nzDashed", booleanAttribute],
    nzPlain: [InputFlags.HasDecoratorInputTransform, "nzPlain", "nzPlain", booleanAttribute]
  },
  exportAs: ["nzDivider"],
  standalone: true,
