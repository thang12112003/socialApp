...
_NzAffixComponent.ɵfac = function NzAffixComponent_Factory(t) {
  return new (t || _NzAffixComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(NzScrollService), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NzResizeObserver), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality));
};
_NzAffixComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzOffsetBottom: [InputFlags.HasDecoratorInputTransform, "nzOffsetBottom", "nzOffsetBottom", numberAttributeWithZeroFallback]
  },
  outputs: {
    nzChange: "nzChange"
  },
...
//# sourceMappingURL=chunk-AS34ECB5.js.map
