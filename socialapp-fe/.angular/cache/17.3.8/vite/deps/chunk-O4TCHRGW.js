...
_NzMessageComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 9,
  vars: 4,
  consts: [[1, "ant-message-notice", 3, "mouseenter", "mouseleave"], [1, "ant-message-notice-content"], [1, "ant-message-custom-content", 3, "ngClass"], [4, "nzStringTemplateOutlet"], ["nz-icon", "", "nzType", "check-circle"], ["nz-icon", "", "nzType", "info-circle"], ["nz-icon", "", "nzType", "exclamation-circle"], ["nz-icon", "", "nzType", "close-circle"], ["nz-icon", "", "nzType", "loading"], [3, "innerHTML"]],
  template: function NzMessageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(3, NzMessageComponent_Case_3_Template, 1, 0)(4, NzMessageComponent_Case_4_Template, 1, 0)(5, NzMessageComponent_Case_5_Template, 1, 0)(6, NzMessageComponent_Case_6_Template, 1, 0)(7, NzMessageComponent_Case_7_Template, 1, 0)(8, NzMessageComponent_ng_container_8_Template, 2, 1, "ng-container", 3);
      ɵɵelementEnd()()();
    }
    if (rf & 2) {
      let tmp_2_0;
      ...
      ɵɵadvance();
      ɵɵconditional(3, (tmp_2_0 = ctx.instance.type) === "success" ? 3 : tmp_2_0 === "info" ? 4 : tmp_2_0 === "warning" ? 5 : tmp_2_0 === "error" ? 6 : tmp_2_0 === "loading" ? 7 : -1);
      ɵɵadvance(5);
