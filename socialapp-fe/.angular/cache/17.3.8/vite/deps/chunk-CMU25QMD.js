...
function NzSpinComponent_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(3, ctx_r0.nzTip ? 3 : -1);
  }
}
...
_NzSpinComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzSize: "nzSize",
    nzTip: "nzTip",
    nzDelay: [InputFlags.HasDecoratorInputTransform, "nzDelay", "nzDelay", numberAttribute],
    nzSimple: [InputFlags.HasDecoratorInputTransform, "nzSimple", "nzSimple", booleanAttribute],
    nzSpinning: [InputFlags.HasDecoratorInputTransform, "nzSpinning", "nzSpinning", booleanAttribute]
  },
  exportAs: ["nzSpin"],
  standalone: true,
  ...
  template: function NzSpinComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵadvance();
      ɵɵconditional(3, !ctx.nzSimple ? 3 : -1);
    }
  },
...
//# sourceMappingURL=chunk-CMU25QMD.js.map
