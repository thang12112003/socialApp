...
_NzInputNumberComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzStatus: "nzStatus",
    nzStep: [InputFlags.HasDecoratorInputTransform, "nzStep", "nzStep", numberAttribute],
    nzInputMode: "nzInputMode",
    nzId: "nzId",
    nzDisabled: [InputFlags.HasDecoratorInputTransform, "nzDisabled", "nzDisabled", booleanAttribute],
    nzReadOnly: [InputFlags.HasDecoratorInputTransform, "nzReadOnly", "nzReadOnly", booleanAttribute],
