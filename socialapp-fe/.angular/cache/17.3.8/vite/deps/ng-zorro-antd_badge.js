...
_NzBadgeSupComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzStyle: "nzStyle",
    nzDot: "nzDot",
    nzOverflowCount: [InputFlags.HasDecoratorInputTransform, "nzOverflowCount", "nzOverflowCount", numberAttribute],
...
_NzBadgeComponent.ɵfac = function NzBadgeComponent_Factory(t) {
  return new (t || _NzBadgeComponent)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Directionality));
};
_NzBadgeComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    nzShowZero: [InputFlags.HasDecoratorInputTransform, "nzShowZero", "nzShowZero", booleanAttribute],
    nzShowDot: [InputFlags.HasDecoratorInputTransform, "nzShowDot", "nzShowDot", booleanAttribute],
    nzStandalone: [InputFlags.HasDecoratorInputTransform, "nzStandalone", "nzStandalone", booleanAttribute],
    nzDot: [InputFlags.HasDecoratorInputTransform, "nzDot", "nzDot", booleanAttribute],
