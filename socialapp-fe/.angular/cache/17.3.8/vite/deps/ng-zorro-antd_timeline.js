...
function NzTimelineItemComponent_ng_template_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(1, ctx_r0.nzLabel ? 1 : -1);
    ɵɵadvance(2);
...
function NzTimelineComponent_ng_template_5_Conditional_0_ng_container_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵconditional(2, !ctx_r2.nzPendingDot ? 2 : -1);
  }
}
...
function NzTimelineComponent_ng_template_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵconditional(0, ctx_r2.nzPending ? 0 : -1);
  }
}
...
_NzTimelineComponent.ɵfac = function NzTimelineComponent_Factory(t) {
  return new (t || _NzTimelineComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(TimelineService), ɵɵdirectiveInject(Directionality));
};
_NzTimelineComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NzTimelineComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵadvance();
      ɵɵconditional(1, ctx.nzReverse ? 1 : -1);
      ɵɵadvance();
      ɵɵrepeater(ctx.timelineItems);
      ɵɵadvance(2);
      ɵɵconditional(4, !ctx.nzReverse ? 4 : -1);
    }
  },
