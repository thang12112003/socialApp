...
_NzDescriptionsItemComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    nzSpan: [InputFlags.HasDecoratorInputTransform, "nzSpan", "nzSpan", numberAttribute],
    nzTitle: "nzTitle"
  },
...
_NzDescriptionsComponent.ɵfac = function NzDescriptionsComponent_Factory(t) {
  return new (t || _NzDescriptionsComponent)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NzBreakpointService), ɵɵdirectiveInject(Directionality));
};
_NzDescriptionsComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzTitle: "nzTitle",
    nzExtra: "nzExtra",
    nzColon: [InputFlags.HasDecoratorInputTransform, "nzColon", "nzColon", booleanAttribute]
  },
...
__decorate([WithConfig()], NzDescriptionsComponent.prototype, "nzBordered", void 0);
...
__decorate([WithConfig()], NzDescriptionsComponent.prototype, "nzColon", void 0);
(() => {
