...
_NzSiderComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzZeroTrigger: "nzZeroTrigger",
    nzTrigger: "nzTrigger",
    nzReverseArrow: [InputFlags.HasDecoratorInputTransform, "nzReverseArrow", "nzReverseArrow", booleanAttribute],
    nzCollapsible: [InputFlags.HasDecoratorInputTransform, "nzCollapsible", "nzCollapsible", booleanAttribute],
    nzCollapsed: [InputFlags.HasDecoratorInputTransform, "nzCollapsed", "nzCollapsed", booleanAttribute]
  },
  outputs: {
...
_NzLayoutComponent.ɵfac = function NzLayoutComponent_Factory(t) {
  return new (t || _NzLayoutComponent)(ɵɵdirectiveInject(Directionality));
};
