...
_NzListComponent.ɵfac = function NzListComponent_Factory(t) {
  return new (t || _NzListComponent)(ɵɵdirectiveInject(Directionality));
};
_NzListComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzSize: "nzSize",
    nzSplit: [InputFlags.HasDecoratorInputTransform, "nzSplit", "nzSplit", booleanAttribute],
    nzNoResult: "nzNoResult"
  },
  exportAs: ["nzList"],
  standalone: true,
...
_NzListItemComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzContent: "nzContent",
    nzExtra: "nzExtra",
    nzNoFlex: [InputFlags.HasDecoratorInputTransform, "nzNoFlex", "nzNoFlex", booleanAttribute]
  },
  exportAs: ["nzListItem"],
  standalone: true,
