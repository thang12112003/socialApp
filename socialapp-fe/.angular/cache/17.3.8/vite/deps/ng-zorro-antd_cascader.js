...
_NzCascaderOptionComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    columnIndex: [InputFlags.HasDecoratorInputTransform, "columnIndex", "columnIndex", numberAttribute],
...
_NzCascaderComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzShowInput: [InputFlags.HasDecoratorInputTransform, "nzShowInput", "nzShowInput", booleanAttribute],
    ...
    nzChangeOnSelect: [InputFlags.HasDecoratorInputTransform, "nzChangeOnSelect", "nzChangeOnSelect", booleanAttribute],
    ...
    nzMouseEnterDelay: [InputFlags.HasDecoratorInputTransform, "nzMouseEnterDelay", "nzMouseEnterDelay", numberAttribute],
    nzMouseLeaveDelay: [InputFlags.HasDecoratorInputTransform, "nzMouseLeaveDelay", "nzMouseLeaveDelay", numberAttribute],
    nzStatus: "nzStatus",
