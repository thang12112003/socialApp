...
_NzResizableService.ɵfac = function NzResizableService_Factory(t) {
  return new (t || _NzResizableService)(ɵɵinject(NgZone));
};
...
_NzResizableDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    ...
    nzMinHeight: [InputFlags.HasDecoratorInputTransform, "nzMinHeight", "nzMinHeight", numberAttribute],
    nzMinWidth: [InputFlags.HasDecoratorInputTransform, "nzMinWidth", "nzMinWidth", numberAttribute],
    nzGridColumnCount: [InputFlags.HasDecoratorInputTransform, "nzGridColumnCount", "nzGridColumnCount", numberAttribute],
    nzMaxColumn: [InputFlags.HasDecoratorInputTransform, "nzMaxColumn", "nzMaxColumn", numberAttribute],
    nzMinColumn: [InputFlags.HasDecoratorInputTransform, "nzMinColumn", "nzMinColumn", numberAttribute],
    nzLockAspectRatio: [InputFlags.HasDecoratorInputTransform, "nzLockAspectRatio", "nzLockAspectRatio", booleanAttribute],
    nzPreview: [InputFlags.HasDecoratorInputTransform, "nzPreview", "nzPreview", booleanAttribute],
