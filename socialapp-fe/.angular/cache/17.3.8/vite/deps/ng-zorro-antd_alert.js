...
_NzAlertComponent.ɵfac = function NzAlertComponent_Factory(t) {
  return new (t || _NzAlertComponent)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality));
};
_NzAlertComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzType: "nzType",
    nzCloseable: [InputFlags.HasDecoratorInputTransform, "nzCloseable", "nzCloseable", booleanAttribute],
    nzShowIcon: [InputFlags.HasDecoratorInputTransform, "nzShowIcon", "nzShowIcon", booleanAttribute],
    nzBanner: [InputFlags.HasDecoratorInputTransform, "nzBanner", "nzBanner", booleanAttribute],
