...
_LightboxComponent.ɵfac = function LightboxComponent_Factory(t) {
  return new (t || _LightboxComponent)(ɵɵdirectiveInject(DOCUMENT, 8), ɵɵdirectiveInject(ConfigurableFocusTrapFactory), ɵɵdirectiveInject(ElementRef));
};
_LightboxComponent.ɵcmp = ɵɵdefineComponent({
...
_Lightbox.ɵfac = function Lightbox_Factory(t) {
  return new (t || _Lightbox)(ɵɵinject(LIGHTBOX_CONFIG, 8), ɵɵinject(Gallery), ɵɵinject(Overlay), ɵɵinject(DomSanitizer));
};
_Lightbox.ɵprov = ɵɵdefineInjectable({
  token: _Lightbox,
...
_GallerizeDirective.ɵfac = function GallerizeDirective_Factory(t) {
  return new (t || _GallerizeDirective)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Gallery), ɵɵdirectiveInject(Lightbox), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(GalleryComponent, 11));
};
_GallerizeDirective.ɵdir = ɵɵdefineDirective({
...
_LightboxDirective.ɵfac = function LightboxDirective_Factory(t) {
  return new (t || _LightboxDirective)(ɵɵdirectiveInject(Lightbox), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2));
};
_LightboxDirective.ɵdir = ɵɵdefineDirective({
  type: _LightboxDirective,
  selectors: [["", "lightbox", ""]],
  inputs: {
    index: [InputFlags.None, "lightbox", "index"],
    id: [InputFlags.None, "gallery", "id"]
  },
  standalone: true
});
...
_LightboxModule.ɵfac = function LightboxModule_Factory(t) {
  return new (t || _LightboxModule)();
};
_LightboxModule.ɵmod = ɵɵdefineNgModule({
...
_LightboxModule.ɵinj = ɵɵdefineInjector({
