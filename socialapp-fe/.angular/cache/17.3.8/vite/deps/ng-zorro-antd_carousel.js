...
_NzCarouselComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    nzEffect: "nzEffect",
    nzEnableSwipe: [InputFlags.HasDecoratorInputTransform, "nzEnableSwipe", "nzEnableSwipe", booleanAttribute],
    nzDots: [InputFlags.HasDecoratorInputTransform, "nzDots", "nzDots", booleanAttribute],
    nzAutoPlay: [InputFlags.HasDecoratorInputTransform, "nzAutoPlay", "nzAutoPlay", booleanAttribute],
    nzAutoPlaySpeed: [InputFlags.HasDecoratorInputTransform, "nzAutoPlaySpeed", "nzAutoPlaySpeed", numberAttribute],
    nzTransitionSpeed: [InputFlags.HasDecoratorInputTransform, "nzTransitionSpeed", "nzTransitionSpeed", numberAttribute],
    nzLoop: "nzLoop",
