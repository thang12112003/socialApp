...
_NgTranscludeDirective.ɵfac = function NgTranscludeDirective_Factory(t) {
  return new (t || _NgTranscludeDirective)(ɵɵdirectiveInject(ViewContainerRef));
};
...
_TabsetConfig.ɵfac = function TabsetConfig_Factory(t) {
  return new (t || _TabsetConfig)();
};
...
_TabsetComponent.ɵfac = function TabsetComponent_Factory(t) {
  return new (t || _TabsetComponent)(ɵɵdirectiveInject(TabsetConfig), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef));
};
...
_TabDirective.ɵfac = function TabDirective_Factory(t) {
  return new (t || _TabDirective)(ɵɵdirectiveInject(TabsetComponent), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2));
};
...
_TabHeadingDirective.ɵfac = function TabHeadingDirective_Factory(t) {
  return new (t || _TabHeadingDirective)(ɵɵdirectiveInject(TemplateRef), ɵɵdirectiveInject(TabDirective));
};
