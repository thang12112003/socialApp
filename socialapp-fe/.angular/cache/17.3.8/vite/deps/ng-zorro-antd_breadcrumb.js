...
_NzBreadCrumbComponent.ɵfac = function NzBreadCrumbComponent_Factory(t) {
  return new (t || _NzBreadCrumbComponent)(ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(Directionality));
};
_NzBreadCrumbComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    nzAutoGenerate: [InputFlags.HasDecoratorInputTransform, "nzAutoGenerate", "nzAutoGenerate", booleanAttribute],
